...
class Custom_Bootstrap_Walker_Nav extends Walker_Nav_Menu {
    ...
    function start_lvl(&$output, $depth = 0, $args = array()) {
        ...
        $output .= "\n$indent<ul class=\"dropdown-menu show pb-lg-0\" aria-labelledby=\"navbarDropdownMenuLink\">\n";
    }
...
function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
    ...
    if ($depth > 0 ) {
        ...
        $item_output .= '<p class="mb-0">';
        $item_output .= '<span class="text-wrap">' . apply_filters('the_title', $item->title, $item->ID) . '</span>';
