$(document).ready(function ($) {
   ...
   */
   ////////////////////////////////// VECTORIAL CLIPART ////////////////////////////////////////////////
    ...
    //ON INPUT CHANGE, CHECK AOS IS LOADED
    $("body").on("change",'#sidepanel *[attribute-name^=data-aos]',function(){
        if (previewFrame.contents().find("body").attr("data-aos-easing")===undefined) swal("In order to use this feature, you need to enable the AOS library in the LiveCanvas backend settings.");     
    });
